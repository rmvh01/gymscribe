...
class WorkoutExercisesRepo:
    ...
    def add_exercise_to_workout(self, workout_exercise: WorkoutExerciseIn):
        with pool.connection() as conn:
            with conn.cursor() as cur:
                ...
                return WorkoutExerciseOut(id=id, **workout_exercise.dict())
    ...
    def remove_exercise_from_workout(self, id: int):
        with pool.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
